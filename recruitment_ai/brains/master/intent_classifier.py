...
INTENT_PATTERNS: dict[str, list[str]] = {
    ...
    "RESUME_EDIT": [
        ...
        r"analyze.*score.*resume",
        r"this resume.*section",
        r"professional.*tone.*resume",
        r"ats.*optimize.*resume",
        r"resume.*ats.*section",
    ],
    "ATS_SCORE": [
        r"ats.*score",
        r"ats.*check",
    ...
    "SKILL_ASSESSMENT": [
        ...
        r"mcq.*for",
        r"^skill assessment:",
        r"interview question about",
        r"candidate answered",
        r"ask.*interview question",
        r"in-demand tech skills",
        r"assessment types",
        r"subtopics.*assessed",
